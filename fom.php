...
function somaInsumoSeguro($valorKG,$valorSeguroKg){
    return $valorKG + $valorSeguroKg;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Valores recebidos
    $valorArroz = $_POST['valorArroz'] * $precoArroz = 90000; 
    $valorNpk = $_POST['valorNpk'] * $precoNpk = 51375;
    $valorKcl= $_POST['valorKcl'] * $precoKcl= 48825;
    $valorUreia = $_POST['valorUreia'] * $precoUreia = 43260;
    ...
    echo "<div class='container mt-5 col-4'>";
        ...
        echo "<h2>Soma do Insumo + Seguro</h2>";
        echo "<p><strong>Resultado em KG: </strong>" . number_format($valorInsumoSeguro = somaInsumoSeguro($valorKG,$valorSeguroKg), 2, ',', '.');
        echo "<p><strong>Resultado em Sacos: </strong>" . number_format(convertInsumoSeguroSacos($valorInsumoSeguro,$taxaSaca), 2, ',', '.');
    echo "</div>";
}
...
<body class="bg-light">
    ...
    <a href="index.php">Voltar</a>
        <h1 class="text-center mb-4">Conversor de Insumos - FOM</h1>
        <form method="POST">
            <div class="mb-3">
